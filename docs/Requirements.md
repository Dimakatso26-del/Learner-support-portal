...
---
## User Story 7 Requirements

### Assessor Dashboard
- As an assessor, I want to monitor learner progress and bookings so I can provide timely support.

### Acceptable Requirements:
- Dashboard must show total learners, pending bookings, overdue tasks, and average completion rate.
- Learner overview must display completion percentage and risk status.
- Assessors must be able to filter learners by status (On Track, At Risk).
- Notifications must trigger for overdue tasks and new bookings.
---
# Project Scope
