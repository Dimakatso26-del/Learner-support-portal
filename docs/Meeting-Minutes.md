...
- class design
# Discussions
- Senzokuhle presented firebase project- Authentication working
- Finalised fields for all 6 collections: learners, assessors, tasks, progress, bookings and challenges
...
# Discussions
- checked all deliverables against rubric: Problem statements, User stories, Firebase design, UI Design, wireframes, Github commits, Security rules draft
